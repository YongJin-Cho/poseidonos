...
# Demo test
echo "rd=seq_r,wd=seq,iorate=max,elapsed=15,interval=3,warmup=3,pause=3,forxfersize=(4k),forrdpct=(100),forthreads=(1,64)" >> ${vdfile}
echo "rd=rand_r,wd=rand,iorate=max,elapsed=15,interval=3,warmup=3,pause=3,forxfersize=(4k),forrdpct=(100),forthreads=(1,64)" >> ${vdfile}

# Full test
#echo "rd=seq_r,wd=seq,iorate=max,elapsed=15,interval=3,warmup=3,pause=3,forxfersize=(4k,8k,16k,128k,256k,512k,1m,4m),forrdpct=(100,70,50,30,0),forthreads=(1,2,4,8,16,32,64,128)" >> ${vdfile}
#echo "rd=rand_r,wd=rand,iorate=max,elapsed=15,interval=3,warmup=3,pause=3,forxfersize=(4k,8k,16k,128k,256k,512k,1m,4m),forrdpct=(100,70,50,30,0),forthreads=(1,2,4,8,16,32,64,128)" >> ${vdfile}
