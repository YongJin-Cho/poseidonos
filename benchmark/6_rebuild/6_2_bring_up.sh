...
DEFAULT_TARGET_NIC1=ens5f0 # TARGET NIC 1
DEFAULT_TARGET_NIC2=ens17f0  # TARGET NIC 2
DEFAULT_NET_IRQ_CPULIST=72-95
DEFAULT_CLEAN_BRINGUP=1
DEFAULT_TRANSPORT=TCP
DEFAULT_TARGET_IP1=10.100.2.22 # TARGET IP 1
DEFAULT_TARGET_IP2=10.100.3.22 # TARGET IP 2
DEFAULT_SUBSYSTEM_COUNT=47
DEFAULT_WRITE_BUFFER_SIZE_IN_MB=8192
DEFAULT_VOLUME_COUNT=47
DEFAULT_VOLUME_SIZE=1563727757312
...
sudo $ROOT_DIR/test/script/set_irq_affinity_cpulist.sh ${NET_IRQ_CPULIST} ${TARGET_NIC1}
sudo $ROOT_DIR/test/script/set_irq_affinity_cpulist.sh ${NET_IRQ_CPULIST} ${TARGET_NIC2}
fi
...
while getopts c:t:a:b:s:w:v:S:i:u:p:q:n:m:h: ARG ; do
case $ARG in
c )
